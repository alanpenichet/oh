    ...
    public static void displayWorld(Object pane) {
    	//Setting size for the pane  
	      ...
	      for(Critter c: population) {
	    	  Shape toAdd = null;
	    	  switch(c.viewShape()) {
	    	  case CIRCLE: Circle circle = new Circle(size/2); toAdd = circle; break;
	    	  case SQUARE: Rectangle square = new Rectangle(size,size); toAdd = square; break;
	    	  case TRIANGLE: //TODO
	    		  break;
	    	  case DIAMOND: break;
	    	  case STAR: break;
	    	  }
	    	  toAdd.setFill(c.viewColor());
	    	  toAdd.setStroke(c.viewOutlineColor());
	    	  gridpane.add(toAdd, c.x_coord, c.y_coord);
	      }
    }
